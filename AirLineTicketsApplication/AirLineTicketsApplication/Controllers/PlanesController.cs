...
namespace AirLineTicketsApplication.Controllers
{
    public class PlanesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,PlaneCode,Model,Image,Luggage,BarOnBoard,NumbrerOfSeats")] Plane plane)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,PlaneCode,Model,Image,Luggage,BarOnBoard,NumbrerOfSeats")] Plane plane)
        {
            if (id != plane.Id)
            {
                return NotFound();
